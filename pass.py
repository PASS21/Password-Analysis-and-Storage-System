...
def dictionary():
    ...
    os=platform.system()
    from os import system
    system('curl -s -o dictionary.txt "https://raw.githubusercontent.com/dolph/dictionary/master/popular.txt" ')
    if os == "Windows":
        words_dict = system('type dictionary.txt')
...
def strength():
    ...
    print(f"Strength of the password is : {passwordStrength}")
...
def get_os():
    ...
    if qn=='y':
        ...
        if os == 'Windows':
            ...
            return 'Installed all requirements for Linux / macOS !'
        else:
